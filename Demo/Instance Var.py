...
# thay đổi giá trị thuế chỉ cho một hóa đơn
hd2.tax = 18
print (f"{hd2.ID()} date {hd2.date} price {hd2.getValue()}")

print ("Tax : " + str(hd1.tax))
print ("Tax : " + str(hd2.tax))
# coi hết thuộc tính của từng instance của class
print (hd1.__dict__)
# coi thuộc tính của class
print (Hoa_Don.__dict__)
